...
class QuestionModelTests(TestCase):
    ...
    def test_is_published_with_old_question(self):
        """
        is_published() returns True for questions are published
    ...
    def test_can_vote_during_the_polling_period(self):
        """
        can_vote() returns True for available questions
    ...
    def test_can_vote_current_after_end_date(self):
        """
        can_vote() returns False for questions that
        the current date is after end_date.
        """
